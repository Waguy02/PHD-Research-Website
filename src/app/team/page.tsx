    ...
    <div className="mx-auto max-w-4xl px-6 py-16">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {teamMembers.map((member) => (
          <div key={member.id} className="rounded-xl border border-gray-200 bg-white p-6 card-hover dark:border-slate-800 dark:bg-slate-900">
            <div className="mb-4 flex items-center gap-4">
              {member.image ? (
                ...
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gray-100 text-lg font-bold text-gray-500 dark:bg-slate-800 dark:text-slate-400">
      ...
      <section className="mt-16">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ...
            <div key={aff.name} className="rounded-xl border border-gray-200 bg-gray-50 p-5 card-hover dark:border-slate-800 dark:bg-slate-800/60">
