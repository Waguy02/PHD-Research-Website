  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-20">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 px-3 py-1.5 text-sm text-gray-500 transition-colors hover:border-blue-300 hover:text-blue-600 dark:border-slate-800 dark:text-slate-400 dark:hover:border-blue-700 dark:hover:text-blue-400"
              >
        ...
        <div className="grid gap-5 md:grid-cols-3">
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 card-hover dark:border-slate-800 dark:bg-slate-800/60">
            ...
            <p className="text-sm leading-relaxed text-gray-500 dark:text-slate-400">
              Sequence models and state space architectures for temporal
              prediction and anomaly detection in financial time series.
            </p>
          </div>
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 card-hover dark:border-slate-800 dark:bg-slate-800/60">
            <h3 className="mb-2 font-semibold text-gray-900 dark:text-slate-100">Journal Entries Anomaly Detection</h3>
            <p className="text-sm leading-relaxed text-gray-500 dark:text-slate-400">
              Detecting manipulation and irregularities in accounting journal
              entries using ML and LLM-based analysis.
            </p>
          </div>
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 card-hover dark:border-slate-800 dark:bg-slate-800/60">
            <h3 className="mb-2 font-semibold text-gray-900 dark:text-slate-100">Fraud Detection</h3>
            <p className="text-sm leading-relaxed text-gray-500 dark:text-slate-400">
            ...
            return (
              ...
              >
                <div className="mb-2 flex flex-wrap items-center gap-2">
                  ...
                  <span className={`rounded px-2 py-0.5 text-xs font-medium ${badge.bg}`}>
                    {badge.label}
                  </span>
                </div>
      ...
      <section className="mt-20">
        <div className="rounded-xl border border-gray-200 bg-gray-50 p-8 dark:border-slate-800 dark:bg-slate-800/60">
