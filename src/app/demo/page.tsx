    ...
    <div className="space-y-2">
      {data.map((item: any, i: number) => (
        <div key={i} className="flex items-center gap-3">
          <span className="w-32 text-xs text-right text-gray-600 dark:text-slate-400 shrink-0">{item[labelKey]}</span>
          <div className="flex-1 h-6 rounded bg-gray-100 dark:bg-slate-700 overflow-hidden">
            <div
          ...
          <span className="w-16 text-xs font-medium text-gray-800 dark:text-slate-200">
  ...
  if (activeTab === "pipeline") {
    return (
      <section className="space-y-8">
            ...
            {pipelineSteps.map((step) => (
              ...
              >
                <div className="mb-2 flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-blue-600 dark:text-blue-400">Step {step.step}</span>
                </div>
                <h3 className="mb-1 text-sm font-semibold text-gray-900 dark:text-slate-100">{step.title}</h3>
                <p className="text-xs leading-relaxed text-gray-500 dark:text-slate-400">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Key stats */}
        <div className="rounded-xl border border-blue-200 bg-blue-50 p-6 dark:border-blue-800 dark:bg-blue-900/30">
          <h3 className="mb-3 text-lg font-semibold text-blue-900 dark:text-blue-200">Pipeline Configuration</h3>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <div>
              <span className="text-sm text-blue-700 dark:text-blue-300">Taxonomy: </span>
              <span className="text-sm font-medium text-blue-900 dark:text-blue-100">US-GAAP 2024</span>
            </div>
            <div>
              <span className="text-sm text-blue-700 dark:text-blue-300">Features extracted: </span>
              <span className="text-sm font-medium text-blue-900 dark:text-blue-100">122 per quarter</span>
            </div>
            <div>
              <span className="text-sm text-blue-700 dark:text-blue-300">Misstatement types: </span>
              <span className="text-sm font-medium text-blue-900 dark:text-blue-100">11 (excl. Marketable Securities)</span>
            </div>
            <div>
              <span className="text-sm text-blue-700 dark:text-blue-300">Fraud categories: </span>
              <span className="text-sm font-medium text-blue-900 dark:text-blue-100">4 (Financial, Regulatory, Ethical, Market)</span>
            </div>
            <div>
              <span className="text-sm text-blue-700 dark:text-blue-300">Summarizer: </span>
              <span className="text-sm font-medium text-blue-900 dark:text-blue-100">Qwen3-32B (open-source)</span>
            </div>
            <div>
              <span className="text-sm text-blue-700 dark:text-blue-300">Max insights: </span>
              <span className="text-sm font-medium text-blue-900 dark:text-blue-100">100 per section</span>
            </div>
          </div>
        </div>
      </section>
  ...
  if (activeTab === "prompt") {
    return (
      <section className="space-y-8">
        {/* System prompt */}
        <div className="rounded-xl border border-blue-200 bg-blue-50 p-6 dark:border-blue-800 dark:bg-blue-900/30">
          <h2 className="mb-4 text-xl font-semibold text-blue-900 dark:text-blue-200">MD&A Summarization Prompt (System)</h2>
          <div className="rounded-lg border border-blue-200 bg-white p-4 dark:border-blue-700 dark:bg-slate-800">
            <pre className="whitespace-pre-wrap text-xs leading-relaxed text-gray-700 dark:text-slate-300">
              {systemPrompt}
            </pre>
          </div>
          <div className="mt-3 grid gap-3 sm:grid-cols-3">
            ...
            <div className="rounded bg-white p-3 text-center dark:bg-slate-800">
              ...
              <div className="text-xs text-gray-400 dark:text-slate-500">summarization model</div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-purple-200 bg-purple-50 p-6 dark:border-purple-800 dark:bg-purple-900/30">
          <h2 className="mb-4 text-xl font-semibold text-purple-900 dark:text-purple-200">Classification Prompt (User)</h2>
          <div className="rounded-lg border border-purple-200 bg-white p-4 dark:border-purple-700 dark:bg-slate-800">
            <pre className="whitespace-pre-wrap text-xs leading-relaxed text-gray-700 dark:text-slate-300">
          ...
          <div className="mt-3">
            <span className="rounded bg-purple-100 px-3 py-1 text-xs font-medium text-purple-700 dark:bg-purple-900/40 dark:text-purple-300">
  ...
  return (
    <section className="space-y-8">
        ...
        {mdaSlides.map((_, i) => (
          <button
            ...
            className={`h-2 rounded-full transition-all ${
              i === slideIdx ? "w-6 bg-blue-600 dark:bg-blue-400" : "w-2 bg-gray-300 hover:bg-gray-400 dark:bg-slate-600 dark:hover:bg-slate-500"
            }`}
          />
        ))}
      </div>
      ...
      <div className="relative flex items-stretch gap-2 sm:gap-3">
        ...
        <button
          onClick={prevSlide}
          className="flex shrink-0 items-center justify-center self-center rounded-xl border border-gray-200 bg-white p-3 shadow-sm transition-all hover:border-blue-300 hover:bg-blue-50 hover:shadow-md dark:border-slate-700 dark:bg-slate-800 dark:hover:border-blue-500 dark:hover:bg-slate-700"
          aria-label="Previous slide"
        >
          <svg className="h-5 w-5 text-gray-600 dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        >
          ...
          <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="text-sm font-semibold text-gray-900 dark:text-slate-100">{slide.company}</span>
              <span className="text-xs text-gray-500 dark:text-slate-400">CIK {slide.cik}</span>
            </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="flex min-w-0 flex-col">
              <h3 className="mb-2 text-sm font-semibold text-gray-700 dark:text-slate-200">
                Raw MD&A (Original 10-Q Filing)
              </h3>
              <div className="max-h-[600px] overflow-y-auto rounded-lg border border-gray-200 bg-white p-4 dark:border-slate-600 dark:bg-slate-800">
                <pre className="whitespace-pre-wrap text-xs leading-relaxed text-gray-700 dark:text-slate-300">
                  {slide.rawMDA}
                </pre>
              </div>
              <div className="mt-2 flex items-center justify-between">
                <span className="text-[11px] text-gray-400 dark:text-slate-500">Scroll for full text &darr;</span>
                <span className="text-sm font-bold text-gray-700 dark:text-slate-200">{slide.rawMDA.split(" ").length.toLocaleString()} <span className="text-xs font-medium text-gray-500 dark:text-slate-400">words</span></span>
              </div>
            </div>
            ...
            <div className="flex min-w-0 flex-col gap-4">
              ...
              <div>
                ...
                <div className="max-h-[360px] overflow-y-auto rounded-lg border border-blue-200 bg-white p-4 dark:border-blue-700 dark:bg-slate-800">
                  <pre className="whitespace-pre-wrap text-xs leading-relaxed text-gray-700 dark:text-slate-300">
                    {slide.smda}
                  </pre>
                </div>
                <div className="mt-2 text-right">
                <span className="text-sm font-bold text-blue-600 dark:text-blue-400">{slide.smda.split(" ").length.toLocaleString()} <span className="text-xs font-medium text-blue-500 dark:text-blue-400">words</span></span>
                <span className="ml-2 text-xs font-semibold text-green-600 dark:text-green-400">({((slide.rawMDA.split(" ").length - slide.smda.split(" ").length) / slide.rawMDA.split(" ").length * 100).toFixed(0)}% reduction)</span>
              </div>
              </div>
              ...
              >
                <h3 className="mb-2 text-sm font-semibold text-gray-800 dark:text-slate-200">AAER Disclosure</h3>
                <p className="mb-2 text-sm leading-relaxed text-gray-700 dark:text-slate-300">{slide.aaerSummary}</p>

                {slide.misstatements.length > 0 && (
                  <div className="mb-2">
                    <span className="text-xs font-medium text-gray-600 dark:text-slate-400">Misstatement Types:</span>
                    <div className="mt-1 flex flex-wrap gap-1">
                      {slide.misstatements.map((mis) => (
                        <span key={mis} className="rounded bg-white px-2 py-0.5 text-xs text-gray-700 dark:bg-slate-700 dark:text-slate-200">
                          {mis}
                        </span>
                      ))}
                    </div>
                ...
                {slide.redFlags.length > 0 && (
                  <div>
                    <span className="text-xs font-medium text-red-600 dark:text-red-400">Red Flags:</span>
                    <ul className="mt-1 space-y-0.5 text-sm text-red-700 dark:text-red-300">
        ...
        {mdaSlides.map((s, i) => (
          <button
            ...
            className={`rounded-lg border px-2.5 py-1.5 text-xs font-medium transition-all ${
              i === slideIdx
                ? "border-blue-300 bg-blue-50 text-blue-700 shadow-sm dark:border-blue-500 dark:bg-blue-900/40 dark:text-blue-300"
      ...
      <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 text-center text-xs text-gray-500 dark:border-slate-700 dark:bg-slate-800/50 dark:text-slate-400">
    ...
    <section className="space-y-8">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-4 sm:p-8 dark:border-slate-700 dark:bg-slate-800">
        ...
        <svg viewBox="0 0 900 560" className="w-full max-w-4xl mx-auto" xmlns="http://www.w3.org/2000/svg" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
          ...
          {/* ====== BOX 1: INPUT ====== */}
          <rect x="30" y="30" width="180" height="80" rx="10" fill="#1e3a5f" stroke="#60a5fa" strokeWidth="2"/>
          <text x="120" y="57" textAnchor="middle" fontSize="12" fontWeight="700" fill="#93c5fd">INPUT</text>
          <text x="120" y="75" textAnchor="middle" fontSize="10" fill="#cbd5e1">FIN (122 features)</text>
          <text x="120" y="90" textAnchor="middle" fontSize="10" fill="#cbd5e1">+ SMD&amp;A (Qwen summary)</text>
          <text x="120" y="105" textAnchor="middle" fontSize="9" fill="#94a3b8">serialized into prompt</text>

          <line x1="210" y1="70" x2="246" y2="70" stroke="#64748b" strokeWidth="2" markerEnd="url(#arrowR)"/>

          {/* ====== BOX 2: Fino1-8B + LoRA ====== */}
          <rect x="250" y="20" width="260" height="100" rx="10" fill="#1e1b4b" stroke="#818cf8" strokeWidth="2"/>
          <rect x="256" y="26" width="248" height="30" rx="6" fill="#312e81"/>
          <text x="380" y="46" textAnchor="middle" fontSize="12" fontWeight="700" fill="#a5b4fc">Fino1-8B + LoRA</text>
          <text x="380" y="68" textAnchor="middle" fontSize="10" fill="#cbd5e1">Frozen backbone · LoRA adapters</text>
          <text x="380" y="84" textAnchor="middle" fontSize="9" fill="#94a3b8">r=8, &alpha;=8, dropout=0.05, lr=1e-4</text>
          <text x="380" y="98" textAnchor="middle" fontSize="9" fill="#94a3b8">Target: q,v,gate,up,down,lm_head</text>
          <text x="380" y="112" textAnchor="middle" fontSize="8" fill="#64748b">4-bit NF4 · 8B params</text>

          <line x1="510" y1="70" x2="546" y2="70" stroke="#64748b" strokeWidth="2" markerEnd="url(#arrowR)"/>

          {/* ====== BOX 3: CLASSIFICATION HEAD ====== */}
          <rect x="550" y="20" width="180" height="100" rx="10" fill="#064e3b" stroke="#34d399" strokeWidth="2"/>
          <rect x="556" y="26" width="168" height="30" rx="6" fill="#065f46"/>
          <text x="640" y="46" textAnchor="middle" fontSize="12" fontWeight="700" fill="#6ee7b7">CLASSIFICATION</text>
          <text x="640" y="68" textAnchor="middle" fontSize="10" fill="#cbd5e1">Softmax (last token)</text>
          <text x="640" y="84" textAnchor="middle" fontSize="9" fill="#94a3b8">Cross-entropy loss</text>
          <text x="640" y="98" textAnchor="middle" fontSize="9" fill="#94a3b8">All other tokens masked</text>
          <text x="640" y="112" textAnchor="middle" fontSize="8" fill="#64748b">YES (fraud) / NO (clean)</text>

          <line x1="730" y1="70" x2="766" y2="70" stroke="#64748b" strokeWidth="2" markerEnd="url(#arrowR)"/>

          {/* ====== BOX 4: OUTPUT ====== */}
          <rect x="770" y="30" width="110" height="80" rx="10" fill="#451a03" stroke="#fbbf24" strokeWidth="2"/>
          <text x="825" y="57" textAnchor="middle" fontSize="12" fontWeight="700" fill="#fcd34d">OUTPUT</text>
          <text x="825" y="78" textAnchor="middle" fontSize="10" fill="#cbd5e1">Fraud / Clean</text>
          <text x="825" y="95" textAnchor="middle" fontSize="9" fill="#94a3b8">AUC · F1</text>

          {/* ====== MIDDLE ROW: Training Config ====== */}
          <rect x="100" y="160" width="700" height="90" rx="10" fill="#1e293b" stroke="#334155" strokeWidth="1.5"/>
          <text x="450" y="182" textAnchor="middle" fontSize="11" fontWeight="700" fill="#cbd5e1">Training Configuration</text>

          {/* Config row */}
          <g>
            <rect x="120" y="194" width="100" height="22" rx="5" fill="#0f172a" stroke="#334155" strokeWidth="1"/>
            <text x="170" y="210" textAnchor="middle" fontSize="9" fontWeight="600" fill="#cbd5e1">Batch: 8</text>
            <rect x="232" y="194" width="100" height="22" rx="5" fill="#0f172a" stroke="#334155" strokeWidth="1"/>
            <text x="282" y="210" textAnchor="middle" fontSize="9" fontWeight="600" fill="#cbd5e1">LR: 1e-4</text>
            <rect x="344" y="194" width="100" height="22" rx="5" fill="#0f172a" stroke="#334155" strokeWidth="1"/>
            <text x="394" y="210" textAnchor="middle" fontSize="9" fontWeight="600" fill="#cbd5e1">Epochs: 10</text>
            <rect x="456" y="194" width="100" height="22" rx="5" fill="#0f172a" stroke="#334155" strokeWidth="1"/>
            <text x="506" y="210" textAnchor="middle" fontSize="9" fontWeight="600" fill="#cbd5e1">AdamW</text>
            <rect x="568" y="194" width="100" height="22" rx="5" fill="#0f172a" stroke="#334155" strokeWidth="1"/>
            <text x="618" y="210" textAnchor="middle" fontSize="9" fontWeight="600" fill="#cbd5e1">bfloat16</text>
            <rect x="680" y="194" width="100" height="22" rx="5" fill="#0f172a" stroke="#334155" strokeWidth="1"/>
            <text x="730" y="210" textAnchor="middle" fontSize="9" fontWeight="600" fill="#cbd5e1">H100 GPU</text>
          </g>

          <rect x="120" y="225" width="660" height="18" rx="5" fill="#0f172a" stroke="#334155" strokeWidth="1"/>
          <text x="450" y="238" textAnchor="middle" fontSize="9" fill="#94a3b8">Feature dropout · Auto-continue checkpoint · Gradient checkpointing (Unsloth)</text>

          {/* ====== BOTTOM ROW: Evaluation ====== */}
          <rect x="100" y="280" width="700" height="105" rx="10" fill="#1e293b" stroke="#334155" strokeWidth="1.5"/>
          <text x="450" y="302" textAnchor="middle" fontSize="11" fontWeight="700" fill="#cbd5e1">Evaluation Strategy</text>

          {/* CI-FSFD */}
          <rect x="120" y="315" width="320" height="55" rx="8" fill="#064e3b" stroke="#34d399" strokeWidth="1.5"/>
          <text x="280" y="335" textAnchor="middle" fontSize="10" fontWeight="700" fill="#6ee7b7">CI-FSFD (Company-Isolated Split)</text>
          <text x="280" y="352" textAnchor="middle" fontSize="9" fill="#94a3b8">5-fold stratified · preserves industry + time</text>
          <text x="280" y="365" textAnchor="middle" fontSize="9" fill="#94a3b8">AUC range: 0.50 – 0.74</text>

          {/* Random Split */}
          <rect x="460" y="315" width="320" height="55" rx="8" fill="#7f1d1d" stroke="#f87171" strokeWidth="1.5"/>
          <text x="620" y="335" textAnchor="middle" fontSize="10" fontWeight="700" fill="#fca5a5">Random Split (Leaky)</text>
          <text x="620" y="352" textAnchor="middle" fontSize="9" fill="#94a3b8">Same company in both sets</text>
          <text x="620" y="365" textAnchor="middle" fontSize="9" fill="#94a3b8">AUC range: 0.87 – 0.96 (inflated)</text>

          {/* ====== OTHER MODELS COMPARED ====== */}
          <rect x="100" y="405" width="700" height="40" rx="10" fill="#1e293b" stroke="#334155" strokeWidth="1"/>
          <text x="450" y="423" textAnchor="middle" fontSize="10" fontWeight="600" fill="#cbd5e1">Other base models compared: Llama-3.1 8B · FinO-8B · FinO-14B</text>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
          <h3 className="mb-4 text-base font-semibold text-gray-900 dark:text-slate-100">LoRA Configuration</h3>
          <div className="space-y-2.5">
            {[
              ...
              <div key={item.label} className="flex items-center justify-between border-b border-gray-100 pb-2 dark:border-slate-700">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
          <h3 className="mb-4 text-base font-semibold text-gray-900 dark:text-slate-100">Base Models &amp; Target Modules</h3>
          <div className="mb-3">
            <span className="mb-2 block text-xs font-medium text-gray-500 dark:text-slate-400">Base Models</span>
            <div className="flex flex-wrap gap-1.5">
              {loraConfig.baseModels.map((m) => (
                <span key={m} className={"rounded-lg border px-2.5 py-1 text-xs font-medium " + (m.includes("Fino1-8B") ? "border-pink-300 bg-pink-50 text-pink-700 dark:border-pink-600 dark:bg-pink-900/40 dark:text-pink-300" : "border-indigo-200 bg-indigo-50 text-indigo-700 dark:border-indigo-600 dark:bg-indigo-900/40 dark:text-indigo-300")}>{m}</span>
              ))}
            </div>
          </div>
          <div>
            <span className="mb-2 block text-xs font-medium text-gray-500 dark:text-slate-400">Target Modules</span>
            <div className="flex flex-wrap gap-1.5">
              {loraConfig.targetModules.map((m) => (
                <span key={m} className="rounded-lg border border-pink-200 bg-pink-50 px-2.5 py-1 text-xs font-medium text-pink-700 dark:border-pink-600 dark:bg-pink-900/40 dark:text-pink-300">{m}</span>
              ))}
            </div>
          </div>
        </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
        <h2 className="mb-5 text-lg font-semibold text-gray-900 dark:text-slate-100">Training Mechanisms</h2>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {[
            ...
            <div key={m.title} className="rounded-lg border border-gray-100 bg-gray-50 p-4 transition-all hover:border-gray-200 hover:shadow-sm dark:border-slate-700 dark:bg-slate-800/50 dark:hover:border-slate-600">
              <div className="mb-2 flex items-center gap-2">
                <span className="text-lg">{m.icon}</span>
                <h3 className="text-sm font-semibold text-gray-900 dark:text-slate-100">{m.title}</h3>
              </div>
              <p className="text-xs leading-relaxed text-gray-500 dark:text-slate-400">{m.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
        <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-slate-100">Data Flow Summary</h2>
        <div className="flex flex-wrap items-center justify-center gap-2 text-xs">
          {[
            { label: "SEC Filings", color: "bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/40 dark:text-blue-300 dark:border-blue-700" },
            { label: "XBRL Parsing", color: "bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/40 dark:text-blue-300 dark:border-blue-700" },
            { label: "122 Features", color: "bg-indigo-100 text-indigo-700 border-indigo-200 dark:bg-indigo-900/40 dark:text-indigo-300 dark:border-indigo-700" },
            { label: "SMD&A Summary", color: "bg-indigo-100 text-indigo-700 border-indigo-200 dark:bg-indigo-900/40 dark:text-indigo-300 dark:border-indigo-700" },
            { label: "Prompt Assembly", color: "bg-purple-100 text-purple-700 border-purple-200 dark:bg-purple-900/40 dark:text-purple-300 dark:border-purple-700" },
            { label: "LoRA Fine-tune", color: "bg-pink-100 text-pink-700 border-pink-200 dark:bg-pink-900/40 dark:text-pink-300 dark:border-pink-700" },
            { label: "Softmax Classifier", color: "bg-green-100 text-green-700 border-green-200 dark:bg-green-900/40 dark:text-green-300 dark:border-green-700" },
            { label: "AUC / F1 Eval", color: "bg-amber-100 text-amber-700 border-amber-200 dark:bg-amber-900/40 dark:text-amber-300 dark:border-amber-700" },
          ].map((step, i) => (
...
function ResultsContent() {
  ...
  return (
    <section className="space-y-8">
      ...
      <div>
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            <div className="mt-0.5 text-xs text-gray-500 dark:text-slate-400">Correct evaluation - no data leakage</div>
          </button>
          <button
            onClick={() => setSplitMethod("random")}
            className={`rounded-lg border px-4 py-2.5 text-sm font-medium transition-all ${
              splitMethod === "random"
                ? "border-red-300 bg-red-50 text-red-700 shadow-sm dark:border-red-500 dark:bg-red-900/40 dark:text-red-300"
                : "border-gray-200 bg-white text-gray-600 hover:border-gray-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400 dark:hover:border-slate-600"
            }`}
          >
            <div className="font-semibold">Random Split</div>
            <div className="mt-0.5 text-xs text-gray-500 dark:text-slate-400">Leaky - same company in train & test</div>
          </button>
        </div>
      </div>
      ...
      {splitMethod === "company" && (
        <>
          <div className="rounded-xl border border-green-200 bg-green-50 p-6 dark:border-green-700 dark:bg-green-900/30">
            <div className="mb-2 flex items-center gap-2">
              <span className="text-lg">&#9989;</span>
              <h3 className="text-lg font-semibold text-green-900 dark:text-green-200">CI-FSFD (Company-Isolated) - Correct Evaluation</h3>
            </div>
            <p className="mb-4 text-sm leading-relaxed text-green-800 dark:text-green-300">
            ...
            <div className="space-y-3">
              {cifdfdData.map((model, idx) => (
                <div key={idx} className="flex items-center gap-3">
                  <span className="w-48 shrink-0 text-sm text-gray-700 dark:text-slate-300">{model.model}</span>
                  <div className="flex-1 h-8 rounded bg-gray-100 dark:bg-slate-700 overflow-hidden relative">
                    <div
                  ...
                  <span className="w-24 text-right text-sm font-bold text-gray-900 dark:text-slate-100">
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-xl border border-green-200 bg-green-50 p-6 dark:border-green-700 dark:bg-green-900/30">
              <h4 className="mb-2 text-base font-semibold text-green-800 dark:text-green-200">Text Dominates</h4>
            ...
            <div className="rounded-xl border border-blue-200 bg-blue-50 p-6 dark:border-blue-700 dark:bg-blue-900/30">
              <h4 className="mb-2 text-base font-semibold text-blue-800 dark:text-blue-200">Domain Adaptation Helps</h4>
            ...
            <div className="rounded-xl border border-purple-200 bg-purple-50 p-6 dark:border-purple-700 dark:bg-purple-900/30">
              <h4 className="mb-2 text-base font-semibold text-purple-800 dark:text-purple-200">Zero-Shot Fails</h4>
      ...
      {splitMethod === "random" && (
        <>
          <div className="rounded-xl border border-red-200 bg-red-50 p-6 dark:border-red-700 dark:bg-red-900/30">
            <div className="mb-2 flex items-center gap-2">
              <span className="text-lg">&#9888;&#65039;</span>
              <h3 className="text-lg font-semibold text-red-900 dark:text-red-200">Random Split - Leaky Evaluation</h3>
            </div>
            <p className="mb-4 text-sm leading-relaxed text-red-800 dark:text-red-300">
            ...
            <div className="space-y-3">
              {randomSplitData.map((model, idx) => (
                <div key={idx} className="flex items-center gap-3">
                  ...
                  <span className="w-24 text-right text-sm font-bold text-red-600 dark:text-red-400">
                    {model.auc.toFixed(2)} AUC
                  </span>
                </div>
              ))}
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-slate-700">
                    <th className="pb-2 text-left text-gray-500 font-medium dark:text-slate-400">Model</th>
                    <th className="pb-2 text-right text-gray-500 font-medium dark:text-slate-400">CI-FSFD AUC</th>
                    <th className="pb-2 text-right text-gray-500 font-medium dark:text-slate-400">Random AUC</th>
                    <th className="pb-2 text-right text-red-600 font-medium dark:text-red-400">Inflation</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={idx} className="border-b border-gray-100 dark:border-slate-700">
                      <td className="py-2 text-gray-700 dark:text-slate-300">{row.model}</td>
                      <td className="py-2 text-right font-medium text-green-700 dark:text-green-400">{row.cifdfd.toFixed(2)}</td>
                      <td className="py-2 text-right font-medium text-red-600 dark:text-red-400">{row.random.toFixed(2)}</td>
                      <td className="py-2 text-right font-bold text-red-600 dark:text-red-400">+{(row.random - row.cifdfd).toFixed(2)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="rounded-lg bg-gray-50 p-4 text-center dark:bg-slate-800/50">
            <div className="text-2xl font-bold text-red-600 dark:text-red-400">0.03%</div>
            <div className="text-xs text-gray-400 dark:text-slate-500">Raw fraud rate</div>
          </div>
          <div className="rounded-lg bg-blue-50 p-4 text-center dark:bg-blue-900/30">
            <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">5%</div>
            <div className="text-xs text-gray-400 dark:text-slate-500">Training fraud rate</div>
          </div>
          <div className="rounded-lg bg-green-50 p-4 text-center dark:bg-green-900/30">
            <div className="text-2xl font-bold text-green-600 dark:text-green-400">10,159</div>
            <div className="text-xs text-gray-400 dark:text-slate-500">Final samples</div>
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-16">
      ...
      <Link
        ...
        className="mb-12 inline-block text-sm font-medium text-blue-600 transition-colors hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300"
      >
        View paper details &rarr;
      </Link>

      {/* What is CI-FSFD */}
      <section className="mb-12 rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-slate-700 dark:bg-slate-800/50">
        <h2 className="mb-2 text-lg font-semibold text-gray-900 dark:text-slate-100">What is CI-FSFD?</h2>
        <p className="leading-relaxed text-gray-600 dark:text-slate-400">
          <strong className="text-gray-800 dark:text-slate-200">Company-Isolated Financial Statement Fraud Detection</strong>{" "}
